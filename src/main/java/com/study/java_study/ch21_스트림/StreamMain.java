...
public class StreamMain {
    public static void main(String[] args) {
        ...
        */
        ...
        // peek() : 중간 결과를 확인할 때 사용
        List<Integer> numberList = st1.map(n -> n * 2) // 가공
                .peek(n -> System.out.println(n))  // 가공(기타 스트림 메소드), 중간 결과를 확인하기 위한 메소드
        ...
        List<Integer> sortedNumbersList = numberList.stream()
                .sorted((o1, o2) -> o2 - o1)
                .collect(Collectors.toList());

        System.out.println(sortedNumbersList);
